        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (String.Equals(Request["password"], Request["Cpassword"]))
                {
                    ...
                    student_table.UpdateStudent(sid, username, firstname, lastname, gender, email, number, password, usertype, department, cgpa, semester,id);
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "message", "alert('Student Info Updated successfully!');location.href = 'Admin.aspx';", true);
